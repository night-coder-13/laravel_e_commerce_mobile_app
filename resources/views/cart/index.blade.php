                        ...
                        <table class="table mb-0">
                            <tbody>
                                @foreach ($cart as $item)
                                    <tr>
                                        <th scope="row">
                                            <a class="remove-product" href="#"><i class="ti ti-x"></i></a>
                                        </th>
                                        <td><img class="rounded" src="img/product/11.png" alt=""></td>
                                        <td>
                                            <a class="product-title" href="single-product.html">
                                                {{ $item['name'] }}
                                                <span class="mt-1">
                ...
                <div class="card cart-amount-area">
                    <div class="card-body d-flex align-items-center justify-content-between">
                        <h5 class="total-price mb-0"> <span class="">ریال</span> <span
                                class="counter">{{ number_format($cart_total_price) }}</span></h5><a class="btn btn-primary"
