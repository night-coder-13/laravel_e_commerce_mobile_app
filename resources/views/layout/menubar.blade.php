<div class="offcanvas offcanvas-start suha-offcanvas-wrap" tabindex="-1" id="suhaOffcanvas"
    ...
    <div class="offcanvas-body">
        ...
        <div class="sidenav-profile">
            <div class="user-profile"><a href="{{ route('profile') }}"><img src="img/bg-img/9.jpg" alt=""></a></div>
            <div class="user-info">
        ...
        <ul class="sidenav-nav ps-0">
            ...
            <li><a href="{{ route('notifications') }}"><i class="ti ti-bell-ringing lni-tada-effect"></i>پیام ها<span
            ...
            <li class="suha-dropdown-menu"><a href="#"><i class="ti ti-building-store"></i>فروشگاه</a>
                <ul>
                    ...
                    <li><a href="">صفحه تک محصول</a></li>
                    <li><a href="{{ route('wishlist') }}">موردعلاقه ها</a></li>
                </ul>
            </li>
            ...
            <li><a href="#"><i class="ti ti-logout"></i>خروج</a></li>
        </ul>
    </div>
</div>